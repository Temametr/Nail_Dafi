...
// Перехід на екран часу після вибору дати
...
function openMasterProfile(id) {
    ...
    document.getElementById('mp-description').innerText = m.about || "Найкращий майстер нашого салону! Опис скоро з'явиться...";
